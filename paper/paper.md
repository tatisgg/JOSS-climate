...
This limitation is increasingly important in regions affected by recurrent droughts and extreme heat. In such settings, electricity access may be critical for water access, cooling, food preservation, health services, communication, and other adaptation needs [@ipcc2022impacts]. A workflow based only on least-cost sequencing may therefore give too little priority to settlements where earlier electrification could support climate adaptation.
